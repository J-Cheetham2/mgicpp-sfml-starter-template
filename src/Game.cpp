...
bool Game::init()
{
	...
	play_text.setFillColor(sf::Color(150, 75, 0));
	...
	quit_text.setFillColor(sf::Color(150, 75, 0));
	...
	livesText.setFillColor(sf::Color(150, 75, 0));
	...
	gameOver_text.setFillColor(sf::Color(150, 75, 0));
	...
	if (!passport_texture_1->loadFromFile("../Data/Images/kenney_physicspack/PNG/Other/penguin passport.png"))
	{
	...
	if (!animal_texture_2->loadFromFile("../Data/Images/kenney_physicspack/PNG/Other//elephant.png"))
	{
		std::cout << "Failed to load elephant.png" << std::endl;
		return false;
	}
	sf::Texture* passport_texture_2 = new sf::Texture();
	if (!passport_texture_2->loadFromFile("../Data/Images/kenney_physicspack/PNG/Other/elephant passport.png"))
	{
	...
	if (!animal_texture_3->loadFromFile("../Data/Images/kenney_physicspack/PNG/Other/giraffe.png"))
	{
		std::cout << "Failed to load giraffe.png" << std::endl;
		return false;
	}
	sf::Texture* passport_texture_3 = new sf::Texture();
	if (!passport_texture_3->loadFromFile("../Data/Images/kenney_physicspack/PNG/Other/moose passport.png"))
	{
	...
	else if (gamestate == IN_GAME)
	{
		...
		else if (event.mouseButton.button == sf::Mouse::Right)
		{
			if (!passport_stamped)
			{
				...
				reject_button->setPosition(click_position_f.x, click_position_f.y + 150);
			}
		}
	}
}
